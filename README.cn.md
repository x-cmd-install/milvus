...
[![x-cmd/install — milvus Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/milvus.svg?lang=zh)](https://x-cmd.com/install/milvus)
...
合计: **2,081,669** 行代码（覆盖前 5 种语言、共 **5291** 个文件）。
...
- **Star**: 46,253 · **Fork**: 4,271 · **开放 issue**: 17,035 · **贡献者**: 350

## 累计统计

- **发布数**: 175 · **已合并 PR**: 27507 · **开放 PR**: 391 · **已关闭 issue**: 15949 · **开放 issue**: 1086 · **提交数**: 25665
